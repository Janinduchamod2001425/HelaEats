    ...
    <div className="h-screen overflow-hidden flex flex-col md:flex-row bg-white">
      ...
      >
        ...
        <img
          src={logoImage}
          alt="Food delivery"
          className="w-[150px] h-[150px] object-cover mb-8"
        />
        ...
        <p className="text-3xl mb-6 max-w-md font-caveat">
        ...
        <div className="space-x-6 mt-2">
          <Link
            to="/login"
            className="px-8 py-3 bg-gradient-to-r from-yellow-400 to-red-500 text-black rounded-xl font-semibold transition-all duration-300 transform border border-transparent hover:bg-white hover:border-black hover:text-black"
          >
            Log In
          </Link>
